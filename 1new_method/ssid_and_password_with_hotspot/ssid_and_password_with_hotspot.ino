...
pinMode(l1,OUTPUT);
 ...
 Firebase.reconnectWiFi(true);
  ...
  {
    ///////////////////////////////////////write code here for mannual button input.//////////////////////////////////////////////////////////////////////
    Serial.print(".");
    delay(100);
    server.handleClient();
    if(rest==1){
...
////write code here for delete eeprom and reset esp8266 /////////////////////////////////////////////////////////////////////////////////////////
...
{
 {
    ...
    server.on("/setting", []() {
      ...
      if (qsid.length() > 0 && qpass.length() > 0) {
       ...
       //change some variable and trigger the timer in loop and then reset.
