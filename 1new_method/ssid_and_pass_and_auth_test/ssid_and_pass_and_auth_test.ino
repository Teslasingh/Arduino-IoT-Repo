...
{
 {
    server.on("/", []() {
      ...
      content += "<p>";
      content += st;
      content += "</p><form method='get' action='setting'><label>SSID: </label><input name='ssid' length=32><input name='pass' length=32><input name='auth' length=96><input type='submit'></form>";
      content += "</html>";
